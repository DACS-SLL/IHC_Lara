    ...
    <div class="container mx-auto text-center p-5">
        ...
        <header class="flex items-center justify-between bg-white p-4 shadow-md">
            ...
            <a href="{{ route('menu') }}" class="flex items-center">
                <img src="{{ asset('images/home.png') }}" alt="Home" class="h-8 w-8 mr-2">
        ...
        <main class="mt-10">
            ...
            <!-- Botón Personalizar -->
            <a href="{{ route('sesiones.reg') }}" class="bg-pink-500 text-white px-4 py-2 mt-8 rounded-lg text-xl font-bold inline-block">
                Personalizar
            </a>
