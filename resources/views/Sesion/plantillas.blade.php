            ...
            <div class="grid grid-cols-3 gap-8 mx-auto mt-5">
                ...
                <div class="bg-white shadow-lg rounded-lg p-5 flex flex-col items-center">
                    ...
                    <div class="flex gap-4">
                        ...
                        <button onclick="showPreview('{{ asset('pdfs/' . $template['file']) }}')" class="bg-indigo-500 text-white px-4 py-2 rounded hover:bg-indigo-600">
                            Vista previa
                        </button>

                        <!-- Botón de descarga -->
                        <a href="{{ asset('pdfs/' . $template['file']) }}" download class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                            Descargar
                        </a>
                    </div>
                </div>
