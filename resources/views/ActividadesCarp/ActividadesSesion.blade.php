        ...
        <main class="mt-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-5">
                ...
                <div class="menu-item flex flex-col items-center">
                    <a href="{{ route('actividades.matematicas') }}" class="flex items-center justify-center w-full px-10 py-6 bg-blue-500 text-white text-xl rounded-lg transition duration-300 hover:bg-blue-700 ml-auto mr-auto">
                        Matemáticas
                    </a>
                    <img src="{{ asset('images/Matematicas.png') }}" alt="Matemáticas" class="w-72 h-64 mt-4">
                </div>

                <!-- Botón y imagen de Comunicación -->
                <div class="menu-item flex flex-col items-center">
                    <a href="{{ route('actividades.comunicacion') }}" class="flex items-center justify-center w-full px-10 py-6 bg-green-500 text-white text-xl rounded-lg transition duration-300 hover:bg-green-700 ml-auto mr-auto">
                        Comunicación
                    </a>
                    <img src="{{ asset('images/Comunicacion.png') }}" alt="Comunicación" class="w-64 h-64 mt-4">
                </div>

                <!-- Botón y imagen de Ciencias -->
                <div class="menu-item flex flex-col items-center">
                    <a href="{{ route('actividades.ciencias') }}" class="flex items-center justify-center w-full px-10 py-6 bg-red-500 text-white text-xl rounded-lg transition duration-300 hover:bg-red-700 ml-auto mr-auto">
                        Ciencia
                    </a>
