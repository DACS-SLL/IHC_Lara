        ...
        <main class="mt-10">
            <div class="flex items-center justify-center gap-10 mb-5">
                ...
                <div class="flex flex-col items-start gap-4">
                    ...
                    <a href="<?php echo e(route('ver.programacion')); ?>" 
                       class="block w-full px-10 py-6 bg-purple-600 text-white text-xl rounded-lg transition duration-300 hover:bg-purple-700 flex items-center">
                        <img src="<?php echo e(asset('images/iconoProgramacion.png')); ?>" alt="Programación" class="h-6 w-6 mr-3">
                        Ver programación
                    </a>

                    <!-- Botón Ingresar Fecha -->
                    <a href="<?php echo e(route('ingresar.fecha')); ?>" 
                       class="block w-full px-10 py-6 bg-purple-600 text-white text-xl rounded-lg transition duration-300 hover:bg-purple-700 flex items-center">
                        <img src="<?php echo e(asset('images/iconoFecha.png')); ?>" alt="Fecha" class="h-6 w-6 mr-3">
                        Ingresar fecha
                    </a>
                </div>
                ...
                <div class="flex justify-center">
                    <img src="<?php echo e(asset('images/calendarioPersonaje.png')); ?>" alt="Imagen del personaje" class="max-w-xs">
                </div>
            </div>            
        </main>
...
</html><?php /**PATH C:\xampp\htdocs\Lara_IHC\InnovEduca\resources\views/Principal/calendar.blade.php ENDPATH**/ ?>