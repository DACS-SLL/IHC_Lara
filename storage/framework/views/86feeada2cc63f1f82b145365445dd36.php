...
<body class="bg-gray-50 font-sans m-0 p-0">
    <div class="container mx-auto text-center p-5">
        ...
        <div class="boton-regresar mt-10">
            <a href="<?php echo e(route('actividades')); ?>" class="flex items-center">
                <img src="<?php echo e(asset('images/flechaIzq.png')); ?>" alt="Regresar" class="h-16 w-16 mr-2">
            </a>
        </div>
    </div>

    <script src="<?php echo e(asset('js/matematicas.js')); ?>"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\Lara_IHC\InnovEduca\resources\views/ActividadesCarp/Matematicas.blade.php ENDPATH**/ ?>